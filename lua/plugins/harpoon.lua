return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>!", function() harpoon:list():replace_at(1) end, { desc = "Replace harpoon file 1 with current file" })
        vim.keymap.set("n", "<leader>\"", function() harpoon:list():replace_at(2) end, { desc = "Replace harpoon file 2 with current file" })
        vim.keymap.set("n", "<leader>#", function() harpoon:list():replace_at(3) end, { desc = "Replace harpoon file 3 with current file" })
        vim.keymap.set("n", "<leader>$", function() harpoon:list():replace_at(4) end, { desc = "Replace harpoon file 4 with current file" })
    end
}
